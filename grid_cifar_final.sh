...
do
    echo ITER $C
    for TRAIN in 1000 2000
    do
	COMMON_ARGS="--MEMORY_SHARE=$MEMORY_SHARE --DISC_TYPE=$DISC_TYPE --DATASET=$DATASET --LEARNING_RATE_DECAY=$LRD --WEIGHT_DECAY=$WD --DO_BATCHNORM=$BN --TRAIN_DATASET_SIZE=$TRAIN"
